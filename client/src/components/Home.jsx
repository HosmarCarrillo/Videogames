...
export default function Home () {
    ...
    const [loaded, setRefreshState] = useState(allVideoGames.length?true:false);
                ...
                <div className='container barr'>
                    ...
                    <div className='ordenar'>
                        <select onChange={ (el)=> {handleSortR(el)}}>
                            <option value="All">Calificacion</option>
                    ...
                    <div className='link'>
                        <Link className='crear' to= '/videogames' >Crear Video Juego</Link>
                    </div>
                <div className='barr3'>
                <Paginado
